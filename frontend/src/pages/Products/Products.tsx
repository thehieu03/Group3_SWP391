...
const Products: FC = () => {
  ...
  const [pagination, setPagination] =
    useState<PaginationResponse<ProductResponse> | null>(null);
      ...
      <div className="flex flex-col gap-5 md:flex-row">
        <aside className="w-full shrink-0 md:w-64">
          <div className="rounded-lg bg-white p-4 shadow">
            ...
            <Button
              className="mt-3 w-full rounded-md bg-emerald-600 px-4 py-2.5 font-semibold text-white hover:bg-emerald-700 md:w-auto"
          ...
          {!loading && pagination && (
            <div className="mb-4 flex items-center justify-between">
              <div className="text-sm text-gray-600">
                Hiển thị {mappedProducts.length} trong tổng số{" "}
