  ...
  useEffect(() => {
    const loadCategories = async () => {
      try {
        ...
        console.error("[SellerDashboard] Lỗi khi tải categories:", e);
        const err = e as unknown as { response?: { status?: number } };
        console.error("[SellerDashboard] Category error details:", {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        setLoading(true);
        setError(null);
        console.log("[SellerDashboard] Bắt đầu tải dashboard với params:", {
          debouncedSearchTerm,
          statusFilter,
          categoryFilter,
          currentPage,
        ...
        console.log("[SellerDashboard] Tải dashboard thành công:", res);
        setData(res);
      } catch (error) {
        console.error("[SellerDashboard] Lỗi khi tải dashboard data:", error);
        const err = error as unknown as {
          response?: { status?: number; data?: unknown };
          config?: unknown;
        };
        console.error("[SellerDashboard] Error details:", {
