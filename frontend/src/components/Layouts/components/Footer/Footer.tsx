import { FaPaperPlane, FaFacebook, FaEnvelope, FaClock, FaRss, FaYoutube } from 'react-icons/fa';
            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center">
                                ...
                                <span className="text-sm text-gray-600">Chat với hỗ trợ viên</span>
                            </div>
                            <div className="flex items-center">
                            ...
                            <div className="flex items-center">
                                ...
                                <span className="text-sm text-gray-600">hieunthe171211@gmail.com</span>
                            </div>
                            <div className="flex items-center">
                                <FaClock className="w-4 h-4 text-gray-500 mr-3" />
                                <span className="text-sm text-gray-600">Mon-Sat 08:00am - 10:00pm</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <button className="bg-green-500 hover:bg-green-600 text-white font-medium py-2 px-6 rounded-md transition-colors duration-200 mb-4">
                            Tham gia
                        </button>
                        <div>
